...
def main():
    """メインテスト実行"""
    print("「すべてのカテゴリ」選択時の固有表現表示修正（ボタン+ハイライト） - テスト開始")
    print("=" * 70)
    ...
    if passed == total:
        ...
        print("- ハイライト表示で「すべて」選択時に各固有表現が赤枠で表示")
